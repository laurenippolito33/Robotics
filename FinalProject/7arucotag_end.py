####aruco node detection at end zone, aruco tag 8
...
# ---------------------------------------------
ARUCO_ID   = 8                 # We look for tag ID=1
ARUCO_DICT = aruco.DICT_4X4_50 # Dictionary to match your printed tag
MARKER_LEN = 0.095      # << TODO: MEASURE YOUR PRINTED TAG SIDE (meters). Example: 4 cm = 0.04
...
class ArucoOnlyNode(Node):
    def __init__(self):
        ...
        self.pub_pose = self.create_publisher(PoseStamped, '/aruco_pose_floor', 10)
